...
import { BellIcon } from "@heroicons/react/24/outline"; // Assicurati di includere questo import
...
function Navbar() {
  ...
  function handleClick() {
    //code per far apparire un componente
    setNotify(notify === true ? false : true);
  }
  return (
    <>
