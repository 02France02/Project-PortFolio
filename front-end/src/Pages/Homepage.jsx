      ...
      <div>
        ...
        <div className="relative flex items-center justify-center ">
          ...
          <div className="relative z-10  bg-opacity-60 p-[6%] rounded-lg text-center flex flex-col items-center gap-5">
            ...
            <p className="text-sm">
              Sviluppo siti e app web su misura che rispecchiano le tue
              ambizioni
            </p>
        ...
        {/* Info tecnology */}
        <div className="video_tech relative flex  justify-center p-[7%]">
          <video
            src={code_video}
          ...
          <div className="z-10">
            ...
            {/* react */}
            <div className="z-10 w-full mt-10 flex flex-wrap justify-center">
        ...
        <div className="video_tech relative flex  justify-center p-[7%]">
          ...
          <div className="z-10 ">
            ...
            <Button text="Progetti" path="/projects"></Button>
          </div>
        </div>
      </div>
    </>
