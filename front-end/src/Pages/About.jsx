      ...
      <div>
        <div className="relative py-16 px-8 sm:px-16 flex flex-col sm:flex-row items-center sm:items-center sm:justify-center">
          <video
            ...
            muted
          ></video>
          <div className="z-10 sm:w-1/2 flex justify-center  w-full  mb-8 sm:mb-0">
            <img
              src={io}
              alt="io"
          ...
          <div className="z-10 w-full sm:w-1/2 flex flex-col justify-center text-center sm:text-left">
        ...
        <div>
          <div className="py-16 px-8 sm:px-16">
            ...
            <p className="text-xs"><b>Nunber:</b> +39 3201852850</p>
            <p className="text-xs"><b>Email: </b> francescofoti44@gmail.com</p>
            <p className="text-xs"><b>City:</b> Brindisi</p>

            <Link to={'https://www.linkedin.com/in/francesco-foti-1a3b232b9/'} className="text-xs"><b className="underline">Linkedin</b></Link> <br />
            <Link to={'https://www.instagram.com/frangifrutti/'} className="text-xs"><b className="underline">Instagram</b></Link>
